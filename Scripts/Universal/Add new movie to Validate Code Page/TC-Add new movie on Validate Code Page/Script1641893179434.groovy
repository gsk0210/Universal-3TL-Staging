...
CustomKeywords.'com.knoldus.universal_staging.AddMovie.clickBuyNow'(longDes, movieGenre, movieRating, buyNowButton, desText, 
    upheUrl, ratingsText, genreText, movieTitle)

@com.kms.katalon.core.annotation.SetUp
def startUniversal() {
    CustomKeywords.'com.knoldus.universal_staging.OpenUniversal.navigateUniversal'()

    CustomKeywords.'com.knoldus.universal_staging.OpenUniversal.logIn'(GlobalVariable.email, GlobalVariable.password)
}
